...
base_folder = "/media/WAMP/" #Make sure the last backslash is there!
start_date = ' '#Set null string (' ') to search over full space
#example: start_date = '/media/WAMP/2018_11_28' 
###############################################################################
    ...
    for folder in sub_folders:
        ...
        if date[0:2] == '20' and folder not in ignore_dates:
            ...
            if beyond:
                ...
                WIP = wampImageProc(root_dir = folder, hour_min = 8, hour_max = 18)
                WIP.display_images()
                '''
